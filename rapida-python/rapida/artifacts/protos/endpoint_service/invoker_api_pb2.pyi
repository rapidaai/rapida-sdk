...
class InvokeRequest(_message.Message):
    ...
    def __init__(self, endpoint: _Optional[_Union[EndpointDefinition, _Mapping]] = ..., args: _Optional[_Mapping[str, str]] = ..., metadata: _Optional[_Mapping[str, str]] = ..., options: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class CallerResponse(_message.Message):
    ...
    response: str
    timeTaken: int
    def __init__(self, requestId: _Optional[int] = ..., response: _Optional[str] = ..., timeTaken: _Optional[int] = ...) -> None: ...
